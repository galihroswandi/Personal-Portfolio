...
export default function Navbar() {
  return (
    <nav className="md:hidden fixed z-10 bottom-0 w-full h-16 bg-primary-blue rounded-t-[27.5px] shadow-inner-shadow px-1 flex items-center justify-between gap-3">
