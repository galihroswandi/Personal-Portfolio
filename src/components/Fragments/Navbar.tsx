...
export default function Navbar() {
  return (
    <nav className="md:hidden fixed z-10 bottom-0 w-full h-16 bg-primary dark:bg-slate-800 rounded-t-[27.5px] shadow-inner-shadow dark:shadow-inner-shadow dark:shadow-slate-900 px-1 flex items-center justify-between gap-3">
