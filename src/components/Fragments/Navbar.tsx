...
export default function Navbar({ children }: { children: ReactNode }) {
  return (
    <nav className="px-5 md:px-0 md:mx-auto pl-3 py-[.1rem] flex justify-between items-center fixed md:static bottom-0 min-w-full md:min-w-0 md:w-[95%] primary border-b. border-b-slate-800. shadow-[0_35px_45px_#1e293b] md:shadow-none">
      {children}
      <ButtonTriggerNavbar />
    </nav>
  );
