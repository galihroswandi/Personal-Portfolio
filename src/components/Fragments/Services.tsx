...
export default function Services() {
  return (
    <section className="mb-6">
      <TextHeaderWithIcon title="Services" desc="services I can provide">
        <svg
      ...
      >
        ...
        <CardService
          ...
          desc="Our Maintenance Service ensures your online hub remains flawless. Let us handle the technicalities while you stay focused on your business goals."
        >
          <svg
            xmlns="http://www.w3.org/2000/svg"
            fill="none"
